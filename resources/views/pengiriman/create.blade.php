        ...
        <div class="row">
                                ...
                                @foreach ($keranjang as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small>Jenis Pengiriman: {{ $item->antar->jenis->nama_layanan }}</small> <br>
                                        ...
                                        <td>
                                            <form role="alert" action="/pengiriman/delete_keranjang/{{ $item->id }}"
                                                method="POST">
                                                <a href="/pengiriman/edit_keranjang/{{ $item->id }}"
            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/pengiriman/keranjang" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            ...
                                            value="{{ old('telepon_penerima') }}" placeholder="081122334455 / 0213322344">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat_penerima" id="alamat_penerima"
                                    class="form-control @error('alamat_penerima') is-invalid @enderror">{{ old('alamat_penerima') }}</textarea>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="merk_type" value="{{ old('merk_type') }}">
                                            @error('merk_type')
                                                <span class="invalid-feedback">
                                                    {{ $message }}
                                                </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" id="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                                        placeholder="Contoh: Lampu belakang tidak rusak">{{ old('keterangan') }}</textarea>
                                    @error('keterangan')
                                        <span class="invalid-feedback">
                                            {{ $message }}
                                        </span>
                        ...
                        <form action="/pengiriman" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                @enderror
                                <input type="hidden" name="noinvoice" id="noinvoice" value="{{ noinvoice() }}">
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat_pengirim" id="alamat_pengirim"
                                    class="form-control @error('alamat_pengirim') is-invalid @enderror">{{ old('alamat_pengirim') }}</textarea>
                            ...
                            <div class="form-group">
                                <input type="hidden" class="form-control @error('potongan') is-invalid @enderror"
                                    id="potongan" name="potongan" value="0">
                                @error('potongan')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                                    </span>
                                ...
                                @foreach ($keranjang as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <small>Biaya Koordinasi:
                                                @currency($item->biaya_koordinasi)</small><br>
                                            <small>Biaya Tambahan:
                                                @currency($item->biaya_tambahan)</small><br>
                                        ...
                                        <td>
                                            <form role="alert"
                                                action="/pengiriman/delete_keranjang/{{ $item->id }}" method="POST">
                                                <a href="/pengiriman/edit_keranjang/{{ $item->id }}"
                                                    class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                                                @csrf
                                                @method('DELETE')
